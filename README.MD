...
### API Beállítások
A szkript futtatásához **Alpaca API kulcs** és **titkos kulcs** szükséges a tőzsdei adatok eléréséhez. Frissítsd a következő sorokat a `main.py` fájlban a saját adataiddal:
